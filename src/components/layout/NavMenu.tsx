        ...
        <nav className="flex flex-col justify-between min-w-12 bg-[#343746] select-none">
            <div className="flex flex-col">
                <ToolTip text="Explorer (Ctrl + b)" position="right">
                    <NavOption active={active} onClick={() => setActive(!active)}>
                        <FilesIcon size={24} strokeWidth={1.5}/>
                    </NavOption>
                </ToolTip>
                <NavOption disabled className=" hidden sm:flex">
                    <BlocksIcon size={24} />
                </NavOption>
                <NavOption disabled className=" hidden md:flex">
                    <SearchIcon size={24} className=" scale-x-[-1]" />
                </NavOption>
                <NavOption disabled className=" hidden lg:flex ">
                    <GitMergeIcon size={24} className="rotate-180 scale-x-[-1]" />
                </NavOption>
                <NavOption disabled className=" hidden lg:flex">
                    <BugPlayIcon size={24} />
                </NavOption>
                <NavOption disabled className=" flex lg:hidden">
