...
export default function VSCodeFlatIcon({size = 24, color = "#000", strokeWidth = 2, className, ...rest}: LucideProps){

    return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" fill={color} strokeWidth={strokeWidth} width={size} height={size} viewBox="0 0 32 32">
