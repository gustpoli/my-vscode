...
export default function VSCodeIcon({size = 24, strokeWidth = 2, ...rest}: LucideProps){

    return (
        <svg xmlns="http://www.w3.org/2000/svg" strokeWidth={strokeWidth} width={size} height={size} viewBox="0 0 100 100" fill="none" {...rest}>
