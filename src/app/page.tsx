...
export default function Home() {
  return (
    <main className="flex-1 flex flex-col justify-evenly items-center gap-5 p-6 overflow-hidden select-none">
      <VSCodeFlatIcon className=" max-w-[85%] w-60 h-auto" color="var(--theme-background-dark)"/>
      <div className="hidden sm:flex flex-col gap-3 w-full text-xs font-medium text-[var(--theme-muted)] text-nowrap">
